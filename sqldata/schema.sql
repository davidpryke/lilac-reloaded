...
(
	...
	`escape_html_tags` TINYINT(1),
	`notes_url_target` VARCHAR(255),
	`action_url_target` VARCHAR(255),
	`enable_splunk_integration` TINYINT(1),
...
(
	...
	`email` VARCHAR(255),
	`pager` VARCHAR(255),
	`host_notifications_enabled` TINYINT(1) NOT NULL,
	`service_notifications_enabled` TINYINT(1) NOT NULL,
	`host_notification_period` INTEGER,
	`service_notification_period` INTEGER,
	`host_notification_on_down` TINYINT(1) NOT NULL,
	`host_notification_on_unreachable` TINYINT(1) NOT NULL,
	`host_notification_on_recovery` TINYINT(1) NOT NULL,
	`host_notification_on_flapping` TINYINT(1) NOT NULL,
	`host_notification_on_scheduled_downtime` TINYINT(1) NOT NULL,
	`service_notification_on_warning` TINYINT(1) NOT NULL,
	`service_notification_on_unknown` TINYINT(1) NOT NULL,
	`service_notification_on_critical` TINYINT(1) NOT NULL,
	`service_notification_on_recovery` TINYINT(1) NOT NULL,
	`service_notification_on_flapping` TINYINT(1) NOT NULL,
	`can_submit_commands` TINYINT(1) NOT NULL,
	`retain_status_information` TINYINT(1) NOT NULL,
	`retain_nonstatus_information` TINYINT(1) NOT NULL,
	PRIMARY KEY (`id`),
...
(
	...
	`passive_checks_enabled` TINYINT(1),
	`check_period` INTEGER,
	`obsess_over_host` TINYINT(1),
	`check_freshness` TINYINT(1),
	`freshness_threshold` INTEGER,
	`active_checks_enabled` TINYINT(1),
	`checks_enabled` TINYINT(1),
	`event_handler` INTEGER,
	`event_handler_enabled` TINYINT(1),
	`low_flap_threshold` INTEGER,
	`high_flap_threshold` INTEGER,
	`flap_detection_enabled` TINYINT(1),
	`process_perf_data` TINYINT(1),
	`retain_status_information` TINYINT(1),
	`retain_nonstatus_information` TINYINT(1),
	`notification_interval` INTEGER,
	`notification_period` INTEGER,
	`notifications_enabled` TINYINT(1),
	`notification_on_down` TINYINT(1),
	`notification_on_unreachable` TINYINT(1),
	`notification_on_recovery` TINYINT(1),
	`notification_on_flapping` TINYINT(1),
	`notification_on_scheduled_downtime` TINYINT(1),
	`stalking_on_up` TINYINT(1),
	`stalking_on_down` TINYINT(1),
	`stalking_on_unreachable` TINYINT(1),
	`failure_prediction_enabled` TINYINT(1),
	`flap_detection_on_up` TINYINT(1),
	`flap_detection_on_down` TINYINT(1),
	`flap_detection_on_unreachable` TINYINT(1),
	`notes` VARCHAR(255),
...
(
	...
	`high_flap_threshold` INTEGER,
	`flap_detection_enabled` TINYINT(1),
	`flap_detection_on_ok` TINYINT(1),
	`flap_detection_on_warning` TINYINT(1),
	`flap_detection_on_critical` TINYINT(1),
	`flap_detection_on_unknown` TINYINT(1),
	`process_perf_data` TINYINT(1),
	`retain_status_information` TINYINT(1),
	`retain_nonstatus_information` TINYINT(1),
	`notification_interval` INTEGER,
	`notification_period` INTEGER,
	`notification_on_warning` TINYINT(1),
	`notification_on_unknown` TINYINT(1),
	`notification_on_critical` TINYINT(1),
	`notification_on_recovery` TINYINT(1),
	`notification_on_flapping` TINYINT(1),
	`notification_on_scheduled_downtime` TINYINT(1),
	`notifications_enabled` TINYINT(1),
	`stalking_on_ok` TINYINT(1),
	`stalking_on_warning` TINYINT(1),
	`stalking_on_unknown` TINYINT(1),
	`stalking_on_critical` TINYINT(1),
	`failure_prediction_enabled` TINYINT(1),
	`notes` VARCHAR(255),
	`notes_url` VARCHAR(255),
	`action_url` VARCHAR(255),
...
(
	...
	`hostgroup` INTEGER,
	`name` VARCHAR(255),
	`execution_failure_criteria_up` TINYINT(1),
	`execution_failure_criteria_down` TINYINT(1),
	`execution_failure_criteria_unreachable` TINYINT(1),
	`execution_failure_criteria_pending` TINYINT(1),
	`execution_failure_criteria_ok` TINYINT(1),
	`execution_failure_criteria_warning` TINYINT(1),
	`execution_failure_criteria_unknown` TINYINT(1),
	`execution_failure_criteria_critical` TINYINT(1),
	`notification_failure_criteria_ok` TINYINT(1),
	`notification_failure_criteria_warning` TINYINT(1),
	`notification_failure_criteria_unknown` TINYINT(1),
	`notification_failure_criteria_critical` TINYINT(1),
	`notification_failure_criteria_pending` TINYINT(1),
	`notification_failure_criteria_up` TINYINT(1),
	`notification_failure_criteria_down` TINYINT(1),
	`notification_failure_criteria_unreachable` TINYINT(1),
	`inherits_parent` TINYINT(1),
...
(
	...
	`escalation_options_up` TINYINT(1),
	`escalation_options_down` TINYINT(1),
	`escalation_options_unreachable` TINYINT(1),
	`escalation_options_ok` TINYINT(1),
	`escalation_options_warning` TINYINT(1),
	`escalation_options_unknown` TINYINT(1),
	`escalation_options_critical` TINYINT(1),
	PRIMARY KEY (`id`),
...
(
	...
	`enable_notifications` TINYINT(1),
	`execute_service_checks` TINYINT(1),
	`accept_passive_service_checks` TINYINT(1),
	`enable_event_handlers` TINYINT(1),
	`log_rotation_method` CHAR,
	`log_archive_path` VARCHAR(255),
	`check_external_commands` TINYINT(1),
	`command_check_interval` VARCHAR(255),
	`command_file` VARCHAR(255),
	`lock_file` VARCHAR(255),
	`retain_state_information` TINYINT(1),
	`state_retention_file` VARCHAR(255),
	`retention_update_interval` INTEGER,
	`use_retained_program_state` TINYINT(1),
	`use_syslog` TINYINT(1),
	`log_notifications` TINYINT(1),
	`log_service_retries` TINYINT(1),
	`log_host_retries` TINYINT(1),
	`log_event_handlers` TINYINT(1),
	`log_initial_states` TINYINT(1),
	`log_external_commands` TINYINT(1),
	`log_passive_checks` TINYINT(1),
	...
	`use_aggressive_host_checking` TINYINT(1),
	`enable_flap_detection` TINYINT(1),
	...
	`soft_state_dependencies` TINYINT(1),
	...
	`obsess_over_services` TINYINT(1),
	`ocsp_command` INTEGER,
	`process_performance_data` TINYINT(1),
	`check_for_orphaned_services` TINYINT(1),
	`check_service_freshness` TINYINT(1),
	...
	`translate_passive_host_checks` TINYINT(1),
	`passive_host_checks_are_soft` TINYINT(1),
	`enable_predictive_host_dependency_checks` TINYINT(1),
	`enable_predictive_service_dependency_checks` TINYINT(1),
	`cached_host_check_horizon` INTEGER,
	`cached_service_check_horizon` INTEGER,
	`use_large_installation_tweaks` TINYINT(1),
	`free_child_process_memory` TINYINT(1),
	`child_processes_fork_twice` TINYINT(1),
	`enable_environment_macros` TINYINT(1),
	`additional_freshness_latency` INTEGER,
	`enable_embedded_perl` TINYINT(1),
	`use_embedded_perl_implicitly` TINYINT(1),
	`p1_file` VARCHAR(255),
	...
	`check_for_updates` TINYINT(1),
	`check_for_orphaned_hosts` TINYINT(1),
	`bare_update_check` TINYINT(1),
	PRIMARY KEY (`id`),
