...
ALTER TABLE `nagios_main_configuration` ADD `temp_path` VARCHAR( 255 ) NOT NULL
ALTER TABLE `nagios_main_configuration` ADD `check_for_updates` TINYINT( 4 ) NOT NULL
ALTER TABLE `nagios_main_configuration` ADD `check_for_orphaned_hosts` TINYINT( 4 ) NOT NULL
ALTER TABLE `nagios_main_configuration` ADD `bare_update_check` TINYINT( 4 ) NOT NULL 
