...
abstract class BaseNagiosContactAddress extends BaseObject  implements Persistent
{
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = NagiosContactAddressQuery::create()
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(NagiosContactAddressPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(NagiosContactAddressPeer::CONTACT)) {
			$modifiedColumns[':p' . $index++]  = '`CONTACT`';
		}
		if ($this->isColumnModified(NagiosContactAddressPeer::ADDRESS)) {
			$modifiedColumns[':p' . $index++]  = '`ADDRESS`';
		}

		$sql = sprintf(
			'INSERT INTO `nagios_contact_address` (%s) VALUES (%s)',
