...
abstract class BaseNagiosContactGroupMember extends BaseObject  implements Persistent
{
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = NagiosContactGroupMemberQuery::create()
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(NagiosContactGroupMemberPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(NagiosContactGroupMemberPeer::CONTACT)) {
			$modifiedColumns[':p' . $index++]  = '`CONTACT`';
		}
		if ($this->isColumnModified(NagiosContactGroupMemberPeer::CONTACTGROUP)) {
			$modifiedColumns[':p' . $index++]  = '`CONTACTGROUP`';
		}

		$sql = sprintf(
			'INSERT INTO `nagios_contact_group_member` (%s) VALUES (%s)',
