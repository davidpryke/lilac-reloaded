...
abstract class BaseImportLogEntryQuery extends ModelCriteria
{
	...
	public function findPk($key, $con = null)
	{
		...
		if ((null !== ($obj = ImportLogEntryPeer::getInstanceFromPool((string) $key))) && !$this->formatter) {
	 ...
	 *
	 * @return    ImportLogEntry A model object, or null if the key is not found
	 */
	protected function findPkSimple($key, $con)
	{
		$sql = 'SELECT `ID`, `JOB`, `TIME`, `TEXT`, `TYPE` FROM `import_log_entry` WHERE `ID` = :p0';
		try {
