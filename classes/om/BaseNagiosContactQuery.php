...
abstract class BaseNagiosContactQuery extends ModelCriteria
{
	...
	public function findPk($key, $con = null)
	{
		...
		if ((null !== ($obj = NagiosContactPeer::getInstanceFromPool((string) $key))) && !$this->formatter) {
