...
abstract class BaseNagiosHostgroupMembership extends BaseObject  implements Persistent
{
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = NagiosHostgroupMembershipQuery::create()
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(NagiosHostgroupMembershipPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(NagiosHostgroupMembershipPeer::HOST)) {
			$modifiedColumns[':p' . $index++]  = '`HOST`';
		}
		if ($this->isColumnModified(NagiosHostgroupMembershipPeer::HOST_TEMPLATE)) {
			$modifiedColumns[':p' . $index++]  = '`HOST_TEMPLATE`';
		}
		if ($this->isColumnModified(NagiosHostgroupMembershipPeer::HOSTGROUP)) {
			$modifiedColumns[':p' . $index++]  = '`HOSTGROUP`';
		}

		$sql = sprintf(
			'INSERT INTO `nagios_hostgroup_membership` (%s) VALUES (%s)',
