...
abstract class BaseNagiosTimeperiodEntry extends BaseObject  implements Persistent
{
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = NagiosTimeperiodEntryQuery::create()
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(NagiosTimeperiodEntryPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(NagiosTimeperiodEntryPeer::TIMEPERIOD_ID)) {
			$modifiedColumns[':p' . $index++]  = '`TIMEPERIOD_ID`';
		}
		if ($this->isColumnModified(NagiosTimeperiodEntryPeer::ENTRY)) {
			$modifiedColumns[':p' . $index++]  = '`ENTRY`';
		}
		if ($this->isColumnModified(NagiosTimeperiodEntryPeer::VALUE)) {
			$modifiedColumns[':p' . $index++]  = '`VALUE`';
		}

		$sql = sprintf(
			'INSERT INTO `nagios_timeperiod_entry` (%s) VALUES (%s)',
