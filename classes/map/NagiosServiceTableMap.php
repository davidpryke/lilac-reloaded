...
class NagiosServiceTableMap extends TableMap
{
	...
	public function buildRelations()
	{
		...
		$this->addRelation('NagiosServiceCheckCommandParameter', 'NagiosServiceCheckCommandParameter', RelationMap::ONE_TO_MANY, array('id' => 'service', ), 'CASCADE', null, 'NagiosServiceCheckCommandParameters');
		$this->addRelation('NagiosServiceGroupMember', 'NagiosServiceGroupMember', RelationMap::ONE_TO_MANY, array('id' => 'service', ), 'CASCADE', null, 'NagiosServiceGroupMembers');
		$this->addRelation('NagiosServiceContactMember', 'NagiosServiceContactMember', RelationMap::ONE_TO_MANY, array('id' => 'service', ), 'CASCADE', null, 'NagiosServiceContactMembers');
		$this->addRelation('NagiosServiceContactGroupMember', 'NagiosServiceContactGroupMember', RelationMap::ONE_TO_MANY, array('id' => 'service', ), 'CASCADE', null, 'NagiosServiceContactGroupMembers');
		$this->addRelation('NagiosDependency', 'NagiosDependency', RelationMap::ONE_TO_MANY, array('id' => 'service', ), 'CASCADE', null, 'NagiosDependencys');
		$this->addRelation('NagiosDependencyTarget', 'NagiosDependencyTarget', RelationMap::ONE_TO_MANY, array('id' => 'target_service', ), 'CASCADE', null, 'NagiosDependencyTargets');
		$this->addRelation('NagiosEscalation', 'NagiosEscalation', RelationMap::ONE_TO_MANY, array('id' => 'service', ), 'CASCADE', null, 'NagiosEscalations');
		$this->addRelation('NagiosServiceTemplateInheritance', 'NagiosServiceTemplateInheritance', RelationMap::ONE_TO_MANY, array('id' => 'source_service', ), 'CASCADE', null, 'NagiosServiceTemplateInheritances');
	} // buildRelations()
