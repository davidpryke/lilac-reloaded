...
class NagiosHostTableMap extends TableMap
{
	...
	public function buildRelations()
	{
		...
		$this->addRelation('NagiosService', 'NagiosService', RelationMap::ONE_TO_MANY, array('id' => 'host', ), 'CASCADE', null, 'NagiosServices');
		$this->addRelation('NagiosHostContactMember', 'NagiosHostContactMember', RelationMap::ONE_TO_MANY, array('id' => 'host', ), 'CASCADE', null, 'NagiosHostContactMembers');
		$this->addRelation('NagiosDependency', 'NagiosDependency', RelationMap::ONE_TO_MANY, array('id' => 'host', ), 'CASCADE', null, 'NagiosDependencys');
		$this->addRelation('NagiosDependencyTarget', 'NagiosDependencyTarget', RelationMap::ONE_TO_MANY, array('id' => 'target_host', ), 'CASCADE', null, 'NagiosDependencyTargets');
		$this->addRelation('NagiosEscalation', 'NagiosEscalation', RelationMap::ONE_TO_MANY, array('id' => 'host', ), 'CASCADE', null, 'NagiosEscalations');
		$this->addRelation('NagiosHostContactgroup', 'NagiosHostContactgroup', RelationMap::ONE_TO_MANY, array('id' => 'host', ), 'CASCADE', null, 'NagiosHostContactgroups');
		$this->addRelation('NagiosHostgroupMembership', 'NagiosHostgroupMembership', RelationMap::ONE_TO_MANY, array('id' => 'host', ), 'CASCADE', null, 'NagiosHostgroupMemberships');
		$this->addRelation('NagiosHostCheckCommandParameter', 'NagiosHostCheckCommandParameter', RelationMap::ONE_TO_MANY, array('id' => 'host', ), 'CASCADE', null, 'NagiosHostCheckCommandParameters');
		$this->addRelation('NagiosHostParentRelatedByChildHost', 'NagiosHostParent', RelationMap::ONE_TO_MANY, array('id' => 'child_host', ), 'CASCADE', null, 'NagiosHostParentsRelatedByChildHost');
		$this->addRelation('NagiosHostParentRelatedByParentHost', 'NagiosHostParent', RelationMap::ONE_TO_MANY, array('id' => 'parent_host', ), 'CASCADE', null, 'NagiosHostParentsRelatedByParentHost');
		$this->addRelation('NagiosHostTemplateInheritance', 'NagiosHostTemplateInheritance', RelationMap::ONE_TO_MANY, array('id' => 'source_host', ), 'CASCADE', null, 'NagiosHostTemplateInheritances');
		$this->addRelation('AutodiscoveryDevice', 'AutodiscoveryDevice', RelationMap::ONE_TO_MANY, array('id' => 'proposed_parent', ), 'SET NULL', null, 'AutodiscoveryDevices');
	} // buildRelations()
