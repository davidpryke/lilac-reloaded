...
class NagiosMainConfigurationTableMap extends TableMap
{
	...
	public function initialize()
	{
		...
		$this->addColumn('ENABLE_NOTIFICATIONS', 'EnableNotifications', 'BOOLEAN', false, 1, null);
		$this->addColumn('EXECUTE_SERVICE_CHECKS', 'ExecuteServiceChecks', 'BOOLEAN', false, 1, null);
		$this->addColumn('ACCEPT_PASSIVE_SERVICE_CHECKS', 'AcceptPassiveServiceChecks', 'BOOLEAN', false, 1, null);
		$this->addColumn('ENABLE_EVENT_HANDLERS', 'EnableEventHandlers', 'BOOLEAN', false, 1, null);
		...
		$this->addColumn('CHECK_EXTERNAL_COMMANDS', 'CheckExternalCommands', 'BOOLEAN', false, 1, null);
		...
		$this->addColumn('RETAIN_STATE_INFORMATION', 'RetainStateInformation', 'BOOLEAN', false, 1, null);
		...
		$this->addColumn('USE_RETAINED_PROGRAM_STATE', 'UseRetainedProgramState', 'BOOLEAN', false, 1, null);
		$this->addColumn('USE_SYSLOG', 'UseSyslog', 'BOOLEAN', false, 1, null);
		$this->addColumn('LOG_NOTIFICATIONS', 'LogNotifications', 'BOOLEAN', false, 1, null);
		$this->addColumn('LOG_SERVICE_RETRIES', 'LogServiceRetries', 'BOOLEAN', false, 1, null);
		$this->addColumn('LOG_HOST_RETRIES', 'LogHostRetries', 'BOOLEAN', false, 1, null);
		$this->addColumn('LOG_EVENT_HANDLERS', 'LogEventHandlers', 'BOOLEAN', false, 1, null);
		$this->addColumn('LOG_INITIAL_STATES', 'LogInitialStates', 'BOOLEAN', false, 1, null);
		$this->addColumn('LOG_EXTERNAL_COMMANDS', 'LogExternalCommands', 'BOOLEAN', false, 1, null);
		$this->addColumn('LOG_PASSIVE_CHECKS', 'LogPassiveChecks', 'BOOLEAN', false, 1, null);
		...
		$this->addColumn('USE_AGGRESSIVE_HOST_CHECKING', 'UseAggressiveHostChecking', 'BOOLEAN', false, 1, null);
		$this->addColumn('ENABLE_FLAP_DETECTION', 'EnableFlapDetection', 'BOOLEAN', false, 1, null);
		...
		$this->addColumn('SOFT_STATE_DEPENDENCIES', 'SoftStateDependencies', 'BOOLEAN', false, 1, null);
		...
		$this->addColumn('OBSESS_OVER_SERVICES', 'ObsessOverServices', 'BOOLEAN', false, 1, null);
		$this->addForeignKey('OCSP_COMMAND', 'OcspCommand', 'INTEGER', 'nagios_command', 'ID', false, null, null);
		$this->addColumn('PROCESS_PERFORMANCE_DATA', 'ProcessPerformanceData', 'BOOLEAN', false, 1, null);
		$this->addColumn('CHECK_FOR_ORPHANED_SERVICES', 'CheckForOrphanedServices', 'BOOLEAN', false, 1, null);
		$this->addColumn('CHECK_SERVICE_FRESHNESS', 'CheckServiceFreshness', 'BOOLEAN', false, 1, null);
		...
		$this->addColumn('EXECUTE_HOST_CHECKS', 'ExecuteHostChecks', 'BOOLEAN', false, 1, null);
		$this->addColumn('SERVICE_INTER_CHECK_DELAY_METHOD', 'ServiceInterCheckDelayMethod', 'VARCHAR', false, 255, null);
		$this->addColumn('USE_RETAINED_SCHEDULING_INFO', 'UseRetainedSchedulingInfo', 'BOOLEAN', false, 1, null);
		$this->addColumn('ACCEPT_PASSIVE_HOST_CHECKS', 'AcceptPassiveHostChecks', 'BOOLEAN', false, 1, null);
		...
		$this->addColumn('AUTO_RESCHEDULE_CHECKS', 'AutoRescheduleChecks', 'BOOLEAN', false, 1, null);
		...
		$this->addColumn('OBSESS_OVER_HOSTS', 'ObsessOverHosts', 'BOOLEAN', false, 1, null);
		$this->addForeignKey('OCHP_COMMAND', 'OchpCommand', 'INTEGER', 'nagios_command', 'ID', false, null, null);
		$this->addColumn('CHECK_HOST_FRESHNESS', 'CheckHostFreshness', 'BOOLEAN', false, 1, null);
		...
		$this->addColumn('USE_REGEXP_MATCHING', 'UseRegexpMatching', 'BOOLEAN', false, 1, null);
		$this->addColumn('USE_TRUE_REGEXP_MATCHING', 'UseTrueRegexpMatching', 'BOOLEAN', false, 1, null);
		$this->addColumn('EVENT_BROKER_OPTIONS', 'EventBrokerOptions', 'VARCHAR', false, 255, null);
		$this->addColumn('DAEMON_DUMPS_CORE', 'DaemonDumpsCore', 'BOOLEAN', false, 1, null);
		...
		$this->addColumn('TRANSLATE_PASSIVE_HOST_CHECKS', 'TranslatePassiveHostChecks', 'BOOLEAN', false, 1, null);
		$this->addColumn('PASSIVE_HOST_CHECKS_ARE_SOFT', 'PassiveHostChecksAreSoft', 'BOOLEAN', false, 1, null);
		$this->addColumn('ENABLE_PREDICTIVE_HOST_DEPENDENCY_CHECKS', 'EnablePredictiveHostDependencyChecks', 'BOOLEAN', false, 1, null);
		$this->addColumn('ENABLE_PREDICTIVE_SERVICE_DEPENDENCY_CHECKS', 'EnablePredictiveServiceDependencyChecks', 'BOOLEAN', false, 1, null);
		...
		$this->addColumn('USE_LARGE_INSTALLATION_TWEAKS', 'UseLargeInstallationTweaks', 'BOOLEAN', false, 1, null);
		$this->addColumn('FREE_CHILD_PROCESS_MEMORY', 'FreeChildProcessMemory', 'BOOLEAN', false, 1, null);
		$this->addColumn('CHILD_PROCESSES_FORK_TWICE', 'ChildProcessesForkTwice', 'BOOLEAN', false, 1, null);
		$this->addColumn('ENABLE_ENVIRONMENT_MACROS', 'EnableEnvironmentMacros', 'BOOLEAN', false, 1, null);
		$this->addColumn('ADDITIONAL_FRESHNESS_LATENCY', 'AdditionalFreshnessLatency', 'INTEGER', false, null, null);
		$this->addColumn('ENABLE_EMBEDDED_PERL', 'EnableEmbeddedPerl', 'BOOLEAN', false, 1, null);
		$this->addColumn('USE_EMBEDDED_PERL_IMPLICITLY', 'UseEmbeddedPerlImplicitly', 'BOOLEAN', false, 1, null);
		...
		$this->addColumn('CHECK_FOR_UPDATES', 'CheckForUpdates', 'BOOLEAN', false, 1, null);
		$this->addColumn('CHECK_FOR_ORPHANED_HOSTS', 'CheckForOrphanedHosts', 'BOOLEAN', false, 1, null);
		$this->addColumn('BARE_UPDATE_CHECK', 'BareUpdateCheck', 'BOOLEAN', false, 1, null);
		// validators
	} // initialize()
